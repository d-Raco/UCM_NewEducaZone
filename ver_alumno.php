  ...
  <div id ="alumno">
    ...
    <div id="contenido">
      <?php
        ...
        $filaClase = $adao->getClase($a->getIdClase());
        ...
        if($_SESSION['rol'] == "padre"){
          ...
          echo "<p>Profesores: </p>";
          $result = $adao->getProfesores($a->getIdClase());
          while($filaAsignatura = $result->fetch_assoc()){
            $filaProfesor = $adao->getProfe($filaAsignatura['id_profesor']);
